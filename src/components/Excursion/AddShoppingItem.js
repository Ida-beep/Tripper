...
function AddShoppingItem(props) {
    ...
    const buttons = [
        <button className="button-secondary-extra-small" onClick={props.editState}>Back</button>,
        <button className="button-secondary-extra-small" disabled={disable()}>Add</button>
    ]
