...
function PreviousDutiesPopup(props) {
    ...
    CAREFUL: /**  this one creates an infinite loop 
    ...
    return (props.trigger) && (
        <PopUp  title={props.title} editState={props.editState}
            ...
            <div className="cards-container">
                <div style={{marginTop:"20px"}} className="card-container">
                    ...
                    <div className="table-container">
                            <TableScaffold onSelection={(selectedItem)=>setExcursionElementToSelected(selectedItem)}
                                tkey={[
                                    "excursionTitle"
                                ]}
                                theaders={[
                ...
                <button className="button-secondary-extra-small" 
                    disabled={disableArrow()} type="button">→</button> 
                    {/* onClick={openExcursion()} */}
                <div style={{marginTop:"20px"}} className="card-container">
                    <h4 style={{fontSize:"20px"}}>Duties</h4>
                    <div className="table-container">
                        <TableScaffold onSelection={(selectedItem)=>setDutyElementToSelected(selectedItem)}
                            tkey={[
                                "name",
                                "minRequired"
                            ]}
